...
export const HCMUT_BTL: TemplateDescriptor = {
  ...
  layout: {
    ...
    atomicBlocks: ['figure', 'equation', 'diagram', 'codeBlock', 'columns'],
    splitTables: true,
    tableOrphans: 2,
    splitLists: true,
...
export const IEEE_LIKE: TemplateDescriptor = {
  ...
  footnotes: { ...SCIENTIFIC_STANDARD.footnotes, fontSize: '0.78em' },
  layout: { ...SCIENTIFIC_STANDARD.layout, orphans: 2, widows: 2 },
};
